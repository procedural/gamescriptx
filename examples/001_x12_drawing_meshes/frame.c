...
__declspec(dllexport) int frame(int recompileRequested, void * dataFromMain) {
  ...
  if (parametersDepthPassRootSignature == 0) {
    ...
    tableRanges[0].RegisterSpace                     = 1; // LightMatrices
    ...
    tableRanges[1].RegisterSpace                     = 4; // in_Vertices
  ...
  if (parametersScenePassRootSignature == 0) {
    ...
    tableRanges[3].RegisterSpace                     = 4; // in_Vertices
    ...
    tableRangesSamplers[0].RegisterSpace                     = 3; // shadowMapSampler
