...
__declspec(dllexport) int frame(int recompileRequested, void * dataFromMain) {
  ...
  if (arrayConstantBufferCameraMatrices == 0) {
    ...
    {
      float * F = (float *)(void *)arrayConstantBufferCameraMatricesData;
      printf(
        "arrayConstantBufferCameraMatricesData:\n"
        "%.9g, %.9g, %.9g, %.9g,\n"
        "%.9g, %.9g, %.9g, %.9g,\n"
        "%.9g, %.9g, %.9g, %.9g,\n"
        "%.9g, %.9g, %.9g, %.9g,\n"
  ...
  if (arrayConstantBufferLightMatrices == 0) {
    ...
    {
      float * F = (float *)(void *)arrayConstantBufferLightMatricesData;
      printf(
        "arrayConstantBufferLightMatricesData:\n"
        "%.9g, %.9g, %.9g, %.9g,\n"
        "%.9g, %.9g, %.9g, %.9g,\n"
        "%.9g, %.9g, %.9g, %.9g,\n"
        "%.9g, %.9g, %.9g, %.9g,\n"
